...
ULTIMATE GOAL: We want to achieve a fully functional Shopify product management tool with batch import, AI-powered optimization, multi-store support, and web interface. Consider missing elements and plan accordingly. If an element is missing, search first to confirm it doesn't exist, then if needed author the specification at specs/FILENAME.md. If you create a new element then document the plan to implement it in @IMPLEMENTATION_PLAN.md using a subagent.
